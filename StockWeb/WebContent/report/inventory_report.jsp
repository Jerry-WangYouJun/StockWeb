...
<title>库存月报</title>
	...
	$(function(){
		...
		$('#data-table').datagrid( {
			url : '${basePath}/report/ReportServlet?method=searchByStock',
			queryParams:{
				startDate:curDate,
				endDate:curDate
			},
...
<body class="easyui-layout">
 <div id="tb" regin="north" title="查询条件区" class="easyui-panel"  style="padding:3px;width:85%" iconCls="icon-search">
		<span>月结开始日期:</span>
	...
	<div regin="center">
		<table id="data-table"   title="数据列表" width="85%"></table>
	</div>
