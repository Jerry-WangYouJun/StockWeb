...
public interface InstockDaoI {
	 ...
	 * 动态列查询
	 */
	public InStockBean[] findByDynamicSelect(String sql, Object[] sqlParams) throws SQLException ;

	/** 
	 * where条件查询，注意每个查询条件都要以 and 或or 逻辑修饰符开头
	 */
	public InStockBean[] findByDynamicWhere(String sql, Object[] sqlParams) throws SQLException ;
	 ...
	 * @throws SQLException 
	 */
	public InStockBean[] findByDynamicWhereByPage(String whereSql, Object[] params,
			int page, int rows) throws SQLException;
	/**
	 * 根据查询条件获得记录总数
	 * @param whereSql  查询条件
